        ...
        render: function() {
            ...
            return(
                ...
                React.DOM.table( {className:"hero-status"}, 
                    ...
                    React.DOM.tr(null, 
                        React.DOM.td( {className:"name", onClick:this.handleClick}, this.props.enemy.attr.name),
    ...
    var ActionMenu = React.createClass({displayName: 'ActionMenu',
        ...
        render: function() {
            if (this.props.showAction) {
                ...
                var enemyMenu = EnemyMenu( {enemy:this.props.enemy, showEnemy:this.state.showEnemy} );
                enemyMenu.handleClick = this.handleClick;
                return enemyMenu;
            }
        }
    });
