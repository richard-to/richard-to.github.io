(function(window, undefined) {
    ...
    var HeroSprite = function(frames) {
        this.frames = $.extend({
            ...
            walkRight: 'face_right_walk_right.png',
            faceRight: 'face_right.png',
            walkUp: 'face_up_walk_left.png',
            faceUp: 'face_up.png',
            walkDown: 'face_down_walk_left.png',
    ...
    HeroSprite.prototype.moveRight = function(map) {
        ...
        if (x < mapLen && map[y][x] == 0) {
            this.x = x;
            this.frameQueue.unshift([frames["face_right_walk_right.png"], x - this.frameStep, y, 3, 0]);
    ...
    HeroSprite.prototype.moveLeft = function(map) {
        ...
        if (x >= 0 && map[y][x] == 0) {
            this.x = x;
            this.frameQueue.unshift([frames["face_left_walk_left.png"], x + this.frameStep, y, 3, 0]);
    ...
    HeroSprite.prototype.moveUp = function(map) {
        ...
        if (y >= 0 && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["face_up_walk_left.png"], x, y + this.frameStep, 3, 0]);
    ...
    HeroSprite.prototype.moveDown = function(map) {
        ...
        if (y < mapLen && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["face_down_walk_left.png"], x, y - this.frameStep, 3, 0]);
