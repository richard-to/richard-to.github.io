...
(function(window, undefined) {
    ...
    GameCanvas.prototype.draw = function() {
        ...
        for (var i = 0; i < this.enemies.length; i++) {
            ...
            this.ctx.fillText(this.enemies[i].attr.name, 75-50+10, py-7);
            py += 125;
        }
        ...
        for (var i = 0; i < this.party.length; i++) {
            ...
            this.ctx.font = '14px Calibri';
            this.ctx.fillStyle = 'white';
            this.ctx.fillText(this.party[0].attr.name, 640-125, py-7);
            py += 125;
        }
    };
    ...
    var hero = new Player({key: 0, name: "Hero"});
    var orc1 = new Enemy({key: 1, name: "Orc 1"});
    var orc2 = new Enemy({key: 2, name: "Orc 2"});
