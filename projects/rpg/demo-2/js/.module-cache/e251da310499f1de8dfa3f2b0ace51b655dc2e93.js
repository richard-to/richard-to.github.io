...
(function(window, undefined) {
    ...
    SpriteAnim.prototype.attackLeft = function(callback) {
        ...
        this.moveLeft();
        var frames = this.frames;
        this.frameQueue.unshift([frames.w_attack_1, this.x, this.y, 10]);
        this.frameQueue.unshift([frames.w_attack_2, this.x-1, this.y, 15]);
    ...
    SpriteAnim.prototype.attackRight = function(callback) {
        ...
        var frames = this.frames;
        this.frameQueue.unshift([frames.w_attack_1, this.x, this.y, 10]);
        this.frameQueue.unshift([frames.w_attack_2, this.x+0.5, this.y, 15]);
