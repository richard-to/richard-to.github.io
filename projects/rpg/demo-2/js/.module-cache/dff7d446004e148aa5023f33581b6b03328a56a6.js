...
(function(window, undefined) {
    ...
    var CombatApp = React.createClass({displayName: 'CombatApp',
        ...
        handleEnemySelect: function(entity, event) {
            entity.takeDamage(this.props.players[0].attack());
            this.props.players[0].takeDamage(this.props.enemies[0].attack());
            this.props.players[0].takeDamage(this.props.enemies[1].attack());
    ...
    React.renderComponent(
        CombatApp( {party:party, enemies:enemies, ctx:ctx} ),
