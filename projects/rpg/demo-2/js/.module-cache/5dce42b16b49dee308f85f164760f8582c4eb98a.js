...
(function(window, undefined) {
    ...
    grpahics.SpriteTile = SpriteTile;
    ...
    grpahics.SpriteAnim = SpriteAnim;
    ...
    grpahics.BgRenderer = BgRenderer;
    ...
    grpahics.SpriteRenderer = SpriteRenderer;

    if (window.rpg === undefined) {
        window.rpg = {};
    }
    window.rpg.grpahics = grpahics;
})(window);
