...
(function(window, undefined) {
    ...
    CombatLevel.prototype.initEnemies = function() {
        ...
        var maxEnemies = 2;
        var numEnemies = iMath.floor((Math.random() * max) + 1);
        enemiesList
        var orc1 = new rpg.entity.Enemy({id: 'e1', name: "Eyeball"});
        var orc2 = new rpg.entity.Enemy({id: 'e2', name: "Bear"});
        ...
        var orc2Sprite = new rpg.graphics.SpriteEnemy(this.spritemeta.frames['bear.png'], this.map, true);
        orc2Sprite.x = 2;
        orc2Sprite.y = 4;
