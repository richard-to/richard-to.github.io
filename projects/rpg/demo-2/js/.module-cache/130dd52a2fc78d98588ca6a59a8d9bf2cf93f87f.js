(function(window, undefined) {
    ...
    // - gridWidth: Canvas width in tiles. More accurately grid width.
    // - screenHeight: Canvas height in tiles.
    //
    var BgRenderer = function(map, tileLookup, tileFactory, tileSize, gridWidth, screenHeight) {
        this.map = map;
        ...
        this.screenMidWidth = Math.floor(this.gridWidth / 2) - 1 - this.gridWidth % 2;
        this.screenRemWidth = this.gridWidth - this.screenMidWidth;
    ...
    //
    var SpriteRenderer = function(map, spriteSheet, tileSize, gridWidth, screenHeight) {
        this.map = map;
        this.spriteSheet = spriteSheet;
        this.tileSize = tileSize;
        this.gridWidth = gridWidth;
    ...
    GameEngine.prototype.initTiles = function() {
        ...
        this.bgRenderer = new BgRenderer(
            ...
            this.options.tileSize, this.options.gridWidth, this.options.screenHeight);
    };
