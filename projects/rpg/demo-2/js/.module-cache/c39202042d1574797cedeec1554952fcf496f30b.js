...
(function(window, undefined) {
    ...
    CombatLevel.prototype.initEnemies = function() {
        ...
        var orc1Sprite = new rpg.graphics.SpriteEnemy(this.spritemeta.frames['octo.png'], this.map, true);
        orc1Sprite.x = 1;
        orc1Sprite.y = 2;
        orc1Sprite.faceRight();

        var orc2Sprite = new rpg.graphics.SpriteEnemy(this.spritemeta.frames['eyeball.png'], this.map, true);
        orc2Sprite.x = 1;
        orc2Sprite.y = 4;
