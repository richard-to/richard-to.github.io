...
(function(window, undefined) {
    ...
    SpriteAnim.prototype.faceRight = function() {
        this.frameQueue.unshift([this.frames.w_face_right, this.x, this.y, 0]);
    };
    ...
    SpriteAnim.prototype.moveRight = function() {
        ...
        if (x < this.map[0].length && this.map[y][x] >= 0) {
            this.x = x;
            this.frameQueue.unshift([frames.w_walk_right_1, x - 0.9, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_right_1, x - 0.8, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_right_1, x - 0.7, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_right, x - 0.6, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_right, x - 0.5, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_right, x - 0.4, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_right_2, x - 0.3, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_right_2, x - 0.2, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_right_2, x - 0.1, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_right, x, y, 0]);
        } else {
            this.faceRight();
        }
    };
    ...
    SpriteAnim.prototype.faceLeft = function() {
        this.frameQueue.unshift([this.frames.w_face_left, this.x, this.y, 0]);
    };
    ...
    SpriteAnim.prototype.moveLeft = function() {
        ...
        if (x >= 0 && this.map[y][x] >= 0) {
            this.x = x;
            this.frameQueue.unshift([frames.w_walk_left_1, x + 0.9, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_left_1, x + 0.8, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_left_1, x + 0.7, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_left, x + 0.6, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_left, x + 0.5, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_left, x + 0.4, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_left_2, x + 0.3, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_left_2, x + 0.2, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_left_2, x + 0.1, y, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_left, x, y, 0]);
        } else {
            this.faceLeft();
        }
    };
    ...
    SpriteAnim.prototype.faceUp = function() {
        this.frameQueue.unshift([this.frames.w_face_up, this.x, this.y, 0]);
    };
    ...
    SpriteAnim.prototype.moveUp = function() {
        ...
        if (y >= 0 && this.map[y][x] >= 0) {
            this.y = y;
            this.frameQueue.unshift([frames.w_walk_up_1, x, y + 0.9, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_up_1, x, y + 0.8, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_up_1, x, y + 0.7, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_up, x, y + 0.6, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_up, x, y + 0.5, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_up, x, y + 0.4, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_up_2, x, y + 0.3, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_up_2, x, y + 0.2, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_up_2, x, y + 0.1, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_up, x, y, 0]);
        } else {
            this.faceUp();
        }
    };
    ...
    SpriteAnim.prototype.faceDown = function() {
        this.frameQueue.unshift([this.frames.w_face_down, this.x, this.y, 0]);
    };
    ...
    SpriteAnim.prototype.moveDown = function() {
        ...
        if (y < this.map.length && this.map[y][x] >= 0) {
            this.y = y;
            this.frameQueue.unshift([frames.w_walk_down_1, x, y - 0.9, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_down_1, x, y - 0.8, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_down_1, x, y - 0.7, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_down, x, y - 0.6, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_down, x, y - 0.5, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_down, x, y - 0.4, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_down_2, x, y - 0.3, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_down_2, x, y - 0.2, this.frameDuration]);
            this.frameQueue.unshift([frames.w_walk_down_2, x, y - 0.1, this.frameDuration]);
            this.frameQueue.unshift([frames.w_face_down, x, y, 0]);
        } else {
            this.faceDown();
        }
    };
    ...
    SpriteAnim.prototype.attackLeft = function(callback) {
        ...
        this.moveLeft();
        var frames = this.frames;
        this.frameQueue.unshift([frames.w_attack_left_1, this.x, this.y, 10]);
        this.frameQueue.unshift([frames.w_attack_left_2, this.x-1, this.y, 15]);
        this.frameQueue.unshift([frames.w_face_left, this.x, this.y, 0]);
        var x = this.x + 1;
        var y = this.y;
        this.frameQueue.unshift([frames.w_walk_left_1, x - 0.9, y, this.frameDuration]);
        this.frameQueue.unshift([frames.w_walk_left_1, x - 0.8, y, this.frameDuration]);
    ...
    SpriteAnim.prototype.attackRight = function(callback) {
        ...
        this.moveRight();
        var frames = this.frames;
        this.frameQueue.unshift([frames.w_attack_right_1, this.x, this.y, 10]);
        this.frameQueue.unshift([frames.w_attack_right_2, this.x+0.5, this.y, 15]);
        this.frameQueue.unshift([frames.w_face_right, this.x, this.y, 0]);
        var x = this.x - 1;
        var y = this.y;
        this.frameQueue.unshift([frames.w_walk_right_1, x + 0.9, y, this.frameDuration]);
        this.frameQueue.unshift([frames.w_walk_right_1, x + 0.8, y, this.frameDuration]);
