(function(window, undefined) {
    ...
    var HeroSprite = function(frames, scale) {
        this.frames = $.extend({
            walkLeft1: 'walk_left_1.png',
            walkLeft2: 'walk_left_2.png',
            faceLeft: 'face_left.png',
            walkRight1: 'walk_right_1.png',
            walkRight2: 'walk_right_2.png',
            faceRight: 'face_right.png',
            walkUp1: 'walk_up_1.png',
            walkUp2: 'walk_up_2.png',
            faceUp: 'face_up.png',
            walkDown1: 'walk_down_1.png',
            walkDown2: 'walk_down_2.png',
            faceDown: 'face_down.png',
            attack1: 'attack1.png',
            attack1: 'attack2.png',
        }, frames);
    ...
    HeroSprite.prototype.faceRight = function(map) {
        this.frameQueue.unshift([this.frames["face_right.png"], this.x, this.y, 0, 0]);
    };
    ...
    HeroSprite.prototype.moveRight = function(map) {
        ...
        if (x < mapLen && map[y][x] == 0) {
            this.x = x;
            this.frameQueue.unshift([frames["walk_right_1.png"], x - this.frameStep, y, 5, 0]);
    ...
    HeroSprite.prototype.moveLeft = function(map) {
        ...
        if (x >= 0 && map[y][x] == 0) {
            this.x = x;
            this.frameQueue.unshift([frames["walk_left_1.png"], x + this.frameStep, y, 5, 0]);
    ...
    HeroSprite.prototype.moveUp = function(map) {
        ...
        if (y >= 0 && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["walk_up_1.png"], x, y + .75, 3, 0]);
            this.frameQueue.unshift([frames["face_up.png"], x, y + .5, 3, 0]);
            this.frameQueue.unshift([frames["walk_up_2.png"], x, y + .25, 3, 0]);
    ...
    HeroSprite.prototype.moveDown = function(map) {
        ...
        if (y < mapLen && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["walk_down_1.png"], x, y - 0.75, 3, 0]);
            this.frameQueue.unshift([frames["face_down.png"], x, y - .5, 3, 0]);
            this.frameQueue.unshift([frames["walk_down_1.png"], x, y - .25, 3, 0]);
