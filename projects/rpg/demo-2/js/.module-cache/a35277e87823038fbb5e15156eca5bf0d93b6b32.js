...
(function(window, undefined) {
    ...
    if (window.rpg === undefined) {
        throw new Error('rpg library is undefined!');
    }
    var rpg = window.rpg;
    ...
    rpg.SpriteRenderer = SpriteRenderer;
