(function(window, undefined) {
    ...
    HeroSprite.prototype.attack = function() {
        this.frameQueue.unshift([this.frames.attack_1, this.x, this.y, this.frameDuration]);
        this.frameQueue.unshift([this.frames.attack_2, this.x, this.y, this.frameDuration]);
    };
