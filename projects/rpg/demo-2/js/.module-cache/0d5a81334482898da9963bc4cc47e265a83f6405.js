...
(function(window, undefined) {
    ...
    CombatLevel.prototype.initEnemies = function() {
        ...
        var orc1Sprite = new rpg.graphics.SpriteAnim(this.spritemeta.frames, this.map);
        orc1Sprite.x = 1;
        orc1Sprite.y = 2;
        orc1Sprite.faceRight();

        var orc2Sprite = new rpg.graphics.SpriteAnim(this.spritemeta.frames, this.map);
        orc2Sprite.x = 1;
        orc2Sprite.y = 4;
    ...
    CombatLevel.prototype.initMenu = function() {
        ...
        React.renderComponent(
            CombatApp( {party:this.party, gameState:gameState, enemies:this.enemies,
