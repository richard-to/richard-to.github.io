...
(function(window, undefined) {
    ...
    SpriteRenderer.prototype.draw = function(ctx, sprite) {
        ...
        if (data) {
            ...
            if (data[3] >= 0) {
                ...
                sprites.lastFrame = data[3];
            }
        } else {
            data = sprites.lastFrame;
        }
    ...
    HeroSprite.prototype.attack = function(callback) {
    ...
    var CombatApp = React.createClass({displayName: 'CombatApp',
        ...
        handleEnemySelect: function(entity, event) {
            ...
            this.props.heroSprite.attack(function() {
   ...
   // Game Engine to control map rendering and intialization.
    ...
    GameEngine.prototype.initCombatMode = function() {
        ...
        this.characters = [
            new HeroSprite(this.frames, this.map),
            new HeroSprite(this.frames, this.map)
        ];

        this.characters[0].x = 1;
        this.characters[0].y = 2.5;
        this.characters[0].faceRight();

        this.characters[1].x = 1;
        this.characters[1].y = 4;
        this.characters[1].faceRight();
        ...
        React.renderComponent(
            CombatApp( {party:party, gameState:gameState, enemies:enemies, heroSprite:this.heroSprite} ),
    ...
    GameEngine.prototype.animate = function() {
        ...
        if (this.heroSprite.hasFrames()) {
            ...
            if (this.characters) {
                this.characters.forEach(function(sprite) {
