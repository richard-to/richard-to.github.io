    ...
    var App = React.createClass({displayName: 'App',
        ...
        handleEnemySelect: function(entity, event) {
            ...
            if (partyTurn < this.props.party.length) {
                ...
                var partyMember = self.props.party[partyTurn].attr.attack;
                this.props.partySprites[partyTurn].attackLeft(function() {
                    ...
                    for (var i = 0; i < enemyCount; i++) {
                        ...
                        if (enemies[i] == entity) {
                            self.props.enemySprites[i].damageSprite.damage = self.props.party[partyTurn].attr.attack;
        ...
        runEnemyAttackSequence: function() {
            ...
            if (enemyTurn < this.props.enemySprites.length) {
                ...
                this.props.enemySprites[enemyTurn].attackRight(this.runEnemyAttackSequence);
