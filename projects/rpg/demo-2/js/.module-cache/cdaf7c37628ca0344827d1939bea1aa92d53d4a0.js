/** @jsx React.DOM */
var HeroStats = React.createClass({displayName: 'HeroStats',displayName: 'HeroStats',
    render: function() {
...
var HeroStatsApp = React.createClass({displayName: 'HeroStatsApp',displayName: 'HeroStatsApp',
