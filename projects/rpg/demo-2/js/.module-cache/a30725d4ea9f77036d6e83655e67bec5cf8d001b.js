...
(function(window, undefined) {
    ...
    CombatLevel.prototype.initEnemies = function() {
        ...
        this.sprites.unshift(this.enemy1);
        this.sprites.unshift(this.enemy2);
    };

    CombatLevel.prototype.initMenu = function() {

        var hero = new rpg.enitity.Player({id: 'h1', name: "Hero"});
        var hero2 = new rpg.enitity.Player({id: 'h2', name: "Hero 2"});
        var orc1 = new rpg.enitity.Enemy({id: 'e1', name: "Orc 1"});
        var orc2 = new rpg.enitity.Enemy({id: 'e2', name: "Orc 2"});
