(function(window, undefined) {
    ...
    HeroSprite.prototype.moveUp = function(map) {
        ...
        if (y >= 0 && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["face_up_walk_left.png"], x, y + .75, 5, 0]);
            this.frameQueue.unshift([frames["face_up.png"], x, y + .5, 5, 0]);
            this.frameQueue.unshift([frames["face_up_walk_right.png"], x, y + .25, 5, 0]);
    ...
    HeroSprite.prototype.moveDown = function(map) {
        ...
        if (y < mapLen && map[y][x] == 0) {
            this.y = y;
            this.frameQueue.unshift([frames["face_down_left.png"], x, y - 0.75, 5, 0]);
            this.frameQueue.unshift([frames["face_down.png"], x, y - .5, 5, 0]);
            this.frameQueue.unshift([frames["face_down_right.png"], x, y - .25, 5, 0]);
