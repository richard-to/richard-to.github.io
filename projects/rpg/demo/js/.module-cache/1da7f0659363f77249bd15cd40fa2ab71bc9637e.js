(function(window, undefined) {
    ...
    HeroSprite.prototype.attack = function() {
        this.frameQueue.unshift([this.frames.attack_1, this.x, this.y, 5]);
        this.frameQueue.unshift([this.frames.attack_2, this.x, this.y, 10]);
        this.frameQueue.unshift([this.frames.face_left, this.x, this.y, 10]);
    };
