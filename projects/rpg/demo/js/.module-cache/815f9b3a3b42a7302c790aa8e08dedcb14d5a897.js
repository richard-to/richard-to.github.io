...
(function(window, undefined) {
    ...
    var EnemyMenu = React.createClass({displayName: 'EnemyMenu',displayName: 'EnemyMenu',
    ...
    var ActionMenu = React.createClass({displayName: 'ActionMenu',displayName: 'ActionMenu',
    ...
    var PartyMenu = React.createClass({displayName: 'PartyMenu',displayName: 'PartyMenu',
        render: function() {
            var createItem = function(entity) {
                return (
                    React.DOM.tr(null,
    ...
    var CombatApp = React.createClass({displayName: 'CombatApp',displayName: 'CombatApp',
