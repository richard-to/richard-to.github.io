(function(window, undefined) {
    ...
    SpriteRenderer.prototype.draw = function(ctx, sprite) {
        ...
        if (data) {
            ...
            ctx.drawImage(spriteSheet,
                frame.x, frame.y, frame.w, frame.h,
                (tileSize - frame.w*2) / 2 + (x) * tileSize,
                (tileSize - frame.h*2) / 2 + tileSize * (y),
                tileSize, tileSize);
    ...
    GameEngine.prototype.initHero = function() {
        ...
        this.heroSprite.faceLeft(this.map);
    };

    GameEngine.prototype.initHero2 = function() {
        this.heroSprite2 = new HeroSprite(
            this.frames, this.spriteSheet, this.map, this.options.tileSize);
        this.heroSprite2.x = 8;
        this.heroSprite2.y = 3.5;
        this.heroSprite2.faceLeft(this.map);

        this.heroSprite3 = new HeroSprite(
            this.frames, this.spriteSheet, this.map, this.options.tileSize);
        this.heroSprite3.x = 8;
        this.heroSprite3.y = 4.5;
        this.heroSprite3.faceLeft(this.map);
    };
    ...
    GameEngine.prototype.animate = function() {
        ...
        if (this.heroSprite.hasFrames()) {
            ...
            this.spriteRenderer.draw(this.ctx, this.heroSprite2);
            this.spriteRenderer.draw(this.ctx, this.heroSprite3);
        }
