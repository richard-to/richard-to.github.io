...
(function(window, undefined) {
    ...
    var HeroStatsApp = React.createClass({displayName: 'HeroStatsApp',
        getInitialState: function() {
            return {showAction: false, showEnemy: true};
        },
        render: function() {
            console.log(this.props);
            return (
                React.DOM.div(null, 
                    ActionMenu( {enemy:this.props.enemy, showEnemy:this.state.showEnemy} ),
                    EnemyMenu( {enemy:this.props.enemy, showEnemy:this.state.showEnemy} ),
