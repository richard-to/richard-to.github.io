...
(function(window, undefined) {
    ...
    var SpriteRenderer = function(map, spriteSheet, tileSize, gridWidth, gridHeight) {
        ...
        //this.gridMidHeight = Math.floor(this.gridHeight / 2) - this.gridHeight % 2;
        this.gridRemHeight = this.gridHeight - this.gridMidHeight;
    };
    ...
    SpriteRenderer.prototype.draw = function(ctx, sprite) {
        ...
        if (data) {
            ...
            console.log(mapLenY - this.gridRemHeight);
            var sy = 0; //cy - this.gridMidHeight;
            var sx = cx - this.gridMidWidth;
            console.log(cy);
            console.log(this.gridMidHeight);
            console.log(sy);
            console.log(y);
            console.log(y - sy);
