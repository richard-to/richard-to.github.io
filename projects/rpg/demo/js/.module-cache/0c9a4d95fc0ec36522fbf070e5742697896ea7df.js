...
(function(window, undefined) {
    ...
    var EnemyMenu = React.createClass({displayName: 'EnemyMenu',
        ...
        render: function() {
            var className = "hero-status";
            if (this.state.show == false) {
                className += " hide-menu"
            }
            return(
                React.DOM.table( {className:"hero-status {this.state.show}"}, 
    ...
    var ActionMenu = React.createClass({displayName: 'ActionMenu',
        ...
        render: function() {
            return (
                React.DOM.table( {className:"action-status {this.state.show}"}, 
                    React.DOM.tr(null, 
    ...
    React.renderComponent(
        EnemyMenu( {enemy:enemy} ),
        document.getElementById('enemy-wrap')
    );
