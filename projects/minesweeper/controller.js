...
(function(window, undefined) {
    ...
    var Controller = function() {
        ...
        for (var i = 0; i < this.numMines; i++) {
            this.mines.push(new Vector2d(
                Math.random() * this.cxClient, Math.random() * this.cyClient));
        }
    };

    Controller.prototype.plotStats = function(ctx) {
    ...
    Controller.prototype.worldTransform = function(vBuffer, vPos) {
        ...
        if (this.ticks++ < Params.numTicks) {
            for (var i = 0; i < this.numSweepers; i++) {
                ...
                if (grabHit >= 0) {
                    ...
                    this.mines[grabHit] = new Vector2d(
                        Math.random() * this.cxClient, Math.random() * this.cyClient);
                }
    ...
    Controller.prototype.getFastRender = function() {
        return this.fastRender;
    };

    Controller.prototype.setFastRender = function(fastRender) {
        this.fastRender = fastRender;
    };

    // Pretty clever way to toggle!
    Controller.prototype.toggleFasterRender = function() {
